...
1. It **takes the inputs and multiplies them with the weights** (including the intercept term $β_0$ , called the bias term)
...
🔑 **Key issue**: the <u>curvature of the objective function is not convex and may be multimodal</u>.
...
2. *Remove each variable in turn and reestimate the network*. <u>This will give N networks each having N – 1 variables</u>.
